...
namespace Nop.Plugin.WebApi.MobSocial.Controllers
{
    ...
    public partial class ArtistPageApiController : BaseMobApiController
    {
        #region variables
        ...
        public ArtistPageApiController(ILocalizationService localizationService,
        ...
        public IHttpActionResult SaveArtist(ArtistPageModel Model)
        {
            ...
            if (!ModelState.IsValid)
                return Response(new { Success = false, Message = "Invalid data submitted. Please check all fields and try again." });
            ...
            */
            ...
            if (IsArtistPageNameAvailable(Model.Name, out artistJson))
            {
                ...
                return Response(new {
                    Success = true,
                    RedirectTo = Url.RouteUrl("ArtistPageUrl", new RouteValueDictionary()
                    {
                        { "SeName" , artistPage.GetSeName(_workContext.WorkingLanguage.Id, true, false) }
                    })
                });
        ...
        public IHttpActionResult SavePageManager(int ArtistPageId, int CustomerId)
        {
            ...
            if (artistPage != null && CanDelete(artistPage))
            {
                ...
                if (customer != null)
                {
                    ...
                    {
                        return Response(new { Success = false, Message = "AlreadyPageManager" });
                    }
                    else
                    {
