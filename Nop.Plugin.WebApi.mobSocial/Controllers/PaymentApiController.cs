...
namespace Nop.Plugin.WebApi.MobSocial.Controllers
{
    ...
    public class PaymentApiController : BaseMobApiController
    {
        ...
        public PaymentApiController(IWorkContext workContext,
        ...
        public IHttpActionResult GetAvailablePaymentMethods([FromUri] CustomerPaymentModel Model)
        {
            ...
            {
                return Json(new {Success = false, AddressRequired = true, Message = "Not addresses found"});
            }
            ...
            if (orders != null)
            {
                ...
                {
                    model.CustomerPendingOrders.Add(new System.Web.Mvc.SelectListItem() {
            ...
            {
                model.CustomerPaymentMethods.Add(new System.Web.Mvc.SelectListItem()
                {
                    Text = pm.NameOnCard + " (" + pm.CardNumberMasked + ")",
                    Value = pm.Id.ToString()
                });
            }
            if(battle.VideoBattleStatus == VideoBattleStatus.Complete)
