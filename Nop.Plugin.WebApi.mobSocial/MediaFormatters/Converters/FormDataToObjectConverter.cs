...
using Nop.Plugin.WebApi.MobSocial.MediaFormatters.Infrastructure.Extensions;

namespace Nop.Plugin.WebApi.MobSocial.MediaFormatters.Converters
{
    public class FormDataToObjectConverter
    {
        ...
        private object CreateObject(Type destinitionType, string propertyName = "")
        {
            ...
            {
                throw new Exception(string.Format("Cannot parse type \"{0}\".", destinitionType.FullName));
            }
            ...
            else
            {
                ...
                if (SourceData.TryGetValue(propertyName, out val))
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new Exception(string.Format("Error parsing field \"{0}\": {1}", propertyName, ex.Message));
                        }
                    }
                }
            }
